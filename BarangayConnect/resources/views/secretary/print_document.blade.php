          ...
          <div class="w-full max-w-screen-lg mx-auto overflow-x-scroll">
            ...
            >
              <thead>
                <tr>
                  ...
                  <th class="w-1/5 text-left text-[#757575] py-2">
                    <span>
                      Request Document
                      <button class="ml-2">
                        <i class="fas fa-sort text-lg"></i>
                  ...
                  <th class="w-1/3 text-[#757575] px-4 py-2">Action</th>
                </tr>
              </thead>
              ...
              <tbody class="">
                ...
                <tr class="text-justify">
                  ...
                  <td
                    class="border-gray-500 mr-2 text-center text-sm border block bg-[#E7F4EE] text-[#0D894F] rounded-full py-2 px-1"
                  >
                ...
                <tr class="text-justify">
                  <td>
                    <div class="flex items-center">
                      ...
                      />
                      <div class="ml-2">
                        <p class="text-[#333843] text-left break-all">
                          User's Name
                        </p>
            ...
            <div class="w-2/3">
              ...
              >
                ...
                <!-- Background Overlay -->
                <div class="bg-white rounded shadow-lg relative w-11/12">
                  <!-- Modal Header -->
              ...
              >
                <div class="fixed inset-0 bg-gray-900 opacity-70"></div>
                <!-- Background Overlay -->
                <div class="bg-white rounded shadow-lg relative w-1/3">
                  <div class="p-3 flex flex-col items-center">
                    <h3 class="text-center">
                      ...
                      <span class="text-lg text-[#8742B4]"
                        >Updated the Request Status</span
                      >
                    </h3>
                  </div>
