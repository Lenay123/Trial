                ...
                <div class="mb-npx">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6 col-12 text-sm-end">
                            <div class="mx-n1">
                                <a href="/adminpage/add/AddSecretary" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Certificate</span>
